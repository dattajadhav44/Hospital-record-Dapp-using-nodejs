...
contract medicalRecords is ERC20Interface {
    ...
    function setDoctorDetails(uint _dId, string memory _dName, string memory _dEmail, uint _dContNum, string memory _dEducation, string memory _dAdd) onlyHospitalOwner public {
    ...
    function setPatientDetails(uint _pId, string memory _pName, string memory _pEmail, uint _pContNum, string memory _padd, uint _consultedDoctor)  onlyHospitalOwner public returns(bool) {
    ...
    function getDoctorDetails(uint _dId) public view returns(string memory, string memory, uint, string memory, string memory) {
    ...
    function getPatientInfo(uint _pId) public view returns(string memory, string memory, uint, string memory, uint) {
